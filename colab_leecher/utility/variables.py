...
class Paths:
    WORK_PATH = "/content/Rasad-Uplaoder/BOT_WORK"
    THMB_PATH = "/content/Rasad-Uplaoder/colab_leecher/Thumbnail.jpg"
    VIDEO_FRAME = f"{WORK_PATH}/video_frame.jpg"
    HERO_IMAGE = f"{WORK_PATH}/Hero.jpg"
    DEFAULT_HERO =  "/content/Rasad-Uplaoder/custom_thmb.jpg"
    MOUNTED_DRIVE = "/content/drive"
    down_path = f"{WORK_PATH}/Downloads"
    temp_dirleech_path = f"{WORK_PATH}/dir_leech_temp"
    mirror_dir = "/content/drive/MyDrive/Rasad Uploads"
...
class Messages:
    caution_msg = "\n\n<i>💖 وقتی این کار را انجام می دهم، کار دیگری انجام دهید ! <b>زیرا، زمان ارزشمند است ✨</b></i>"
    download_name = ""
    task_msg = ""
    status_head = f"<b>📥 درحال دانلود » </b>\n"
    dump_task = ""
    src_link = ""
    link_p = ""
